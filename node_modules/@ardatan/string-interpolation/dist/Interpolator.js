...
var _getValueFromObject = require("./lib/getValueFromObject");
...
class Interpolator {
  ...
  applyData(key, data) {
    ...
    if (alias) {
      const value = (0, _getValueFromObject.getValueFromObject)(alias.ref, data);
    ...
    return key.indexOf('.') > 0 || key.indexOf('[') > 0 ? (0, _getValueFromObject.getValueFromObject)(key, data) : data[key];
  }
